...
export function ensure_latest_json_schema (payload_raw) {
  let file_version = payload_raw.collections.SettingsToClient.settings.SchemaVersion
  ...
  return payload_raw.collections
}
